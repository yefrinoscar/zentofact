...
function movementDetail(movement: Movement) {
  ...
  return [movement.source, movement.orderId ? `pedido ${movement.orderId}` : null].filter(Boolean).join(' · ');
}
