...
const apiHttp = {
  ...
  autoEmitSendNotification: (input: { title: string; message: string }) => req('/auto-emit/notifications', { method: 'POST', body: JSON.stringify(input) }),
  autoEmitSendFailedAlertTest: () => req('/auto-emit/alerts/test', { method: 'POST' }),
