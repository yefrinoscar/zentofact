...
test('Envío propio solo aparece para admin, fuera de Pedidos', () => {
  const item = { to: '/envio-propio', adminOnly: true };
  const can = () => true;
  ...
  assert.equal(isNavItemActive('/envio-propio', '/envio-propio'), true);
