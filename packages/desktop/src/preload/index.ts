...
const api = {
  ...
  falabellaApiGetProducts: (companyId: number, filters: any) => ipcRenderer.invoke('falabella-api:get-products', { companyId, filters }),
  falabellaApiCreateProduct: (companyId: number, product: any) => ipcRenderer.invoke('falabella-api:create-product', { companyId, product }),
  falabellaApiGetFeeds: (companyId: number, filters: any) => ipcRenderer.invoke('falabella-api:get-feeds', { companyId, filters }),
  falabellaApiGetFeedStatus: (companyId: number, feedId: string) => ipcRenderer.invoke('falabella-api:get-feed-status', { companyId, feedId }),
