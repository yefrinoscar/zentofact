...
<!-- Explain the problem or opportunity and why this change is needed. -->
...
- [ ] Major — breaking change requiring users or integrations to adapt (`release:major`)

Reason:

<!-- Explain why the selected release type applies. -->
