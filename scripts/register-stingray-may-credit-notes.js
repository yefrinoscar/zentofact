...
async function insertCreditNote(client, row) {
  ...
  const result = await client.query(
    `insert into credit_notes (
      ...
      '0','0',$17,'0','0',
      $18,$19,$20,$21,$22,
      $23::jsonb,$24::jsonb,'ACEPTADO',$25,'sistema:importacion-sunat-stingray-notas-mayo-2026',
      $26,$26
    ) returning id`,
    [
...
async function main() {
  ...
  writeCsv('registro_notas_credito_stingray_mayo.csv', results, columns);
  ...
  const lines = [
    '# Registro notas de credito STINGRAY mayo 2026', '',
    ...
    '', 'Detalle: `registro_notas_credito_stingray_mayo.csv`',
  ];
  fs.writeFileSync(path.join(OUT_DIR, 'registro_notas_credito_stingray_mayo.md'), `${lines.join('\n')}\n`);
