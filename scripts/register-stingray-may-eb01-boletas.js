...
const COMPANY_ID = 6;
const BRANCH_ID = 6;
const CSV_FILE = process.env.STINGRAY_CSV
  || '/Users/ylaurach/Library/CloudStorage/OneDrive2-Personal/zentoo/SELLERS/STINGRAY/MAYO/LE206125956752026060014040001EXP2.csv';
...
function buildDetail(row) {
  ...
  return [{
    ...
    descripcion: 'Comprobante EB01 (contingencia, emitido manualmente) importado de SUNAT mayo 2026 STINGRAY',
...
async function insertBoleta(client, row) {
  ...
  const result = await client.query(
    `insert into boletas (
      ...
      '0','0',$13,'0','0',
      $14,$15,$16,$17,$18,
      $19::jsonb,$20::jsonb,$21,$22,'sistema:importacion-sunat-stingray-eb01-mayo-2026',
      $23,$23
    ) returning id`,
    [
...
async function main() {
  ...
  writeCsv('registro_eb01_stingray_mayo.csv', results,
  ...
  const lines = [
    '# Registro EB01 (contingencia manual) STINGRAY mayo 2026', '',
    ...
    '', 'Detalle: `registro_eb01_stingray_mayo.csv`',
  ];
  fs.writeFileSync(path.join(OUT_DIR, 'registro_eb01_stingray_mayo.md'), `${lines.join('\n')}\n`);
